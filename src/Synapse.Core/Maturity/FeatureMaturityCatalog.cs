...
public static class FeatureMaturityCatalog
{
    ...
    [
        ...
        new("Plugins.CSharp", "API plugins C# sandboxée", MaturityTier.EarlyAccess,
            "Chargement AssemblyLoadContext; surface API encore mince."),
        new("Network.P2P", "P2P multi-pairs", MaturityTier.Experimental,
            "TCP localhost / labo; pas un réseau collaboratif production."),
        new("Network.WAN", "P2P WAN (NAT + AES-GCM)", MaturityTier.Experimental,
            "Rendez-vous UDP sur loopback; chiffrement réel, traversal NAT non production."),
        new("VR.OpenXR", "OpenXR / swapchain Vulkan", MaturityTier.Experimental,
            "Détection loader + handles d'images synthétiques; pas d'intégration OpenXR réelle."),

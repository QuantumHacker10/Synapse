...
namespace Synapse.Runtime
{
    ...
    public sealed partial class EngineHost : IAsyncDisposable
    {
        ...
        /// <summary>Releases evolution, LLM, quality, collaboration, render, and blueprint resources safely.</summary>
        public async ValueTask DisposeAsync()
        {
            ...
            {
                _logger.Warn("EngineHost", $"Collaboration dispose: {ex.Message}");
            }
